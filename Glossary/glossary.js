...
let glossaryData = [
    ...
    {abbrv: "GA",   title: "General Arrangement", description: "Technical drawing showing the structures layout."},
    {abbrv: "DPR",  title: "Ground Penetrating Radar", description: "Non-destructive testing that scans concrete/surfacing for reinforcement and/or post-tensioned elements."},
