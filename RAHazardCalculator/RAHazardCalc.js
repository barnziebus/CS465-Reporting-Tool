...
let exampleRow1 = new Row(tableEl, setRiskHazardLevels)

let addRowButton = document.getElementById("add row button");
addRowButton.addEventListener("click", () => {
    new Row(tableEl, setRiskHazardLevels)
})

function setRiskHazardLevels() {
    let RHLs = getHazardRiskLevel()
